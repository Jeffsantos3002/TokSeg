  ...
  return (
    <footer className="py-8 bg-dark text-white">
      <dialog id="my_modal_3" className="modal" role="dialog">
        <div className="modal-box overflow-hidden bg-dark2 space-y-4">
          ...
          <div class="col-12 h-96 overflow-auto py-4 bg-dark rounded-md px-4">
            <p class="mb-20">
              Este site é mantido e operado por Faculdade de Administração e
              Negócios de Sergipe.
            </p>
            <p>
            ...
            <ul class="list">
              <li class="mb-2">
                <i class="far fa-circle"></i>Quem deve utilizar nosso site;
              </li>
              <li class="mb-2">
                <i class="far fa-circle"></i>Quais dados coletamos e o que
                fazemos com eles;
              </li>
              <li class="mb-2">
                <i class="far fa-circle"></i>Seus direitos em relação aos seus
                dados pessoais;
              </li>
              <li class="mb-2">
                <i class="far fa-circle"></i>Como entrar em contato conosco.
              </li>
            </ul>
            ...
            <ul class="list">
              <li class="mb-2">
                <i class="far fa-circle"></i>Nome completo
              </li>
              <li class="mb-2">
                <i class="far fa-circle"></i>CPF
              </li>
              <li class="mb-2">
                <i class="far fa-circle"></i>Email
              </li>
              <li class="mb-2">
                <i class="far fa-circle"></i>Telefone
              </li>
              <li class="mb-2">
                <i class="far fa-circle"></i>Data de nascimento
              </li>
              <li class="mb-2">
                <i class="far fa-circle"></i>Endereço residencial
              </li>
            </ul>
            <p>A coleta destes dados ocorre nos seguintes momentos:</p>
            <p class="mb-20">
              Preenchimento de formulário de mais informações sobre cursos
            </p>
            <p class="mb-20">
            ...
            <ul class="list">
              <li class="mb-2">
                <i class="far fa-circle"></i>Para que possa participar dos
                nossos cursos;
              </li>
              <li class="mb-2">
                <i class="far fa-circle"></i>Para que o usuário possa receber
                mais informações sobre nossos cursos;
              </li>
              <li class="mb-2">
                <i class="far fa-circle"></i>Para que o usuário seja atendindo
                pela nossa central de atendimento online;
              </li>
              <li class="mb-2">
                <i class="far fa-circle"></i>Para que possamos enviar nossos
                produtos aos usuários cadastrados;
              </li>
              <li class="mb-2">
                <i class="far fa-circle"></i>Para que possamos enviar ofertas de
                cursos para os cadastrados.
              </li>
            </ul>
            <p>
              <strong>2. Dados sensíveis</strong>
            </p>
            <p class="mb-20">
            ...
            <p>
              <strong>3. Dados de crianças e adolescentes</strong>
            </p>
            <p class="mb-20">
            ...
            <ul class="list">
              ...
              <li class="mb-2">
                <i class="far fa-circle"></i>E-mail
              </li>
              <li class="mb-2">
                <i class="far fa-circle"></i>Nome do Pai
              </li>
              <li class="mb-2">
                <i class="far fa-circle"></i>Nome da Mãe
              </li>
            </ul>
            <p>
              A coleta de dados de crianças e adolescentes acontece nos
              seguintes momentos:
            </p>
            <p>No momento que o usuário faz seu cadastro em cursos.</p>
            <p>
              Os dados de crianças e de adolescentes que coletamos são
              utilizados exclusivamente com as seguintes finalidades:
            </p>
            <p>Para que possamos fazer a inscrição no cursos.</p>
            <p>
              O tratamento de dados de crianças e adolescentes é realizado com
              base no melhor interesse da criança ou do adolescente.
            </p>
            <p>
            ...
            <p>
              ...
              que, por meio deles, se tenha acesso a informações pessoais que
              não tenham partido do usuário ou da forma como utiliza os recursos
              do site.
            </p>
            ...
            <p>
              ...
              nosso site de forma personalizada, por meio da obtenção de dados
              de navegação extraídos a partir de sua interação com o site.
            </p>
            <p>
              O usuário poderá obter mais informações sobre os cookies de
              terceiro e sobre a forma como os dados obtidos a partir dele são
              tratados, além de ter acesso à descrição dos cookies utilizados e
              de suas características, acessando o seguinte link:
            </p>
            <p>
              Google Analitics
              <br />
            ...
            <p>
              ...
              informações sobre como fazer isso em alguns dos principais
              navegadores utilizados hoje podem ser acessadas a partir dos
              seguintes links:
            </p>
            <p>
              Internet Explorer:
            ...
            <p>
              ...
              consequência possível é remoção das preferências do usuário que
              eventualmente tiverem sido salvas, prejudicando sua experiência.
            </p>
            <p>
              <strong>5. Coleta de dados não previstos expressamente</strong>
            </p>
            <p>
            ...
            <p>
              Nós compartilhamos alguns dos dados pessoais mencionados nesta
              seção com terceiros.
            </p>
            <p>Os dados compartilhados são os seguintes:</p>
            <p>
              Com empresas de marketing, publicidade e propaganda que trabalha
              em campanhas de publicidade em divulgação de cursos e
              vestibulares.
            </p>
            <p>
            ...
            <p>
              Para o usuários possam receber informações dos cursos de seu
              interesse.
            </p>
            <p>
            ...
            <p>
              Uma base legal para o tratamento de dados pessoais nada mais é que
              um fundamento jurídico, previsto em lei, que justifica. Assim,
              cada operação de tratamento de dados pessoais precisa ter uma base
              legal a ela correspondente.
            </p>
            <p>1. Dados pessoais não sensíveis</p>
            <p>
              Nós tratamos os dados pessoais não sensíveis de nossos usuários
              nas seguintes hipóteses:
            </p>
            <ul class="list">
              <li class="mb-2">
                <i class="far fa-circle"></i>mediante o consentimento do titular
                dos dados pessoais;
              </li>
              <li class="mb-2">
                <i class="far fa-circle"></i>para o cumprimento de obrigação
                legal ou regulatória pelo controlador;
              </li>
              <li class="mb-2">
                <i class="far fa-circle"></i>para o exercício regular de
                direitos em processo judicial, administrativo ou arbitral;
              </li>
              <li class="mb-2">
                <i class="far fa-circle"></i>quando necessário para atender aos
                interesses legítimos do controlador ou de terceiro;
              </li>
              <li class="mb-2">
                <i class="far fa-circle"></i>para a proteção do crédito.
              </li>
            </ul>
            <p>2. Dados de crianças e adolescentes</p>
            <p>
              O tratamento de dados de crianças e adolescentes é feito com base
              no consentimento de pelo menos um de seus pais ou responsáveis.
            </p>
            <p>
              Poderão ser coletados dados pessoais de crianças sem o
              consentimento mencionado no parágrafo anterior quando a coleta for
              necessária para contatar os pais ou o responsável legal,
              utilizados uma única vez e sem armazenamento, ou para sua
              proteção.
            </p>
            <p>3. Consentimento</p>
            <p>
              Determinadas operações de tratamento de dados pessoais realizadas
              em nosso site dependerão da prévia concordância do usuário, que
              deverá manifestá-la de forma livre, informada e inequívoca.
            </p>
            <p>
              O usuário poderá revogar seu consentimento a qualquer momento,
              sendo que, não havendo hipótese legal que permita ou que demande o
              armazenamento dos dados, os dados fornecidos mediante
              consentimento serão excluídos.
            </p>
            <p>
              ...
              funcionalidade do site que dependa daquela operação. As
              consequências da falta de consentimento para uma atividade
            ...
            <p>
              ...
              baseamos exclusivamente em nosso interesse legítimo. Para saber
              mais sobre em quais casos, especificamente, nos valemos desta base
              legal, ou para obter mais informações sobre os testes que fazemos
              para termos certeza de que podemos utilizá-la, entre em contato
              com nosso Encarregado de Proteção de Dados Pessoais por algum dos
              canais informados nesta Política de Privacidade, na seção “Como
              entrar em contato conosco”.
            </p>
            <p>6. Direitos do usuário</p>
            <p>
              O usuário do site possui os seguintes direitos, conferidos pela
              Lei de Proteção de Dados Pessoais:
            </p>
            <ul class="list">
              <li class="mb-2">
                <i class="far fa-circle"></i>confirmação da existência de
                tratamento;
              </li>
              <li class="mb-2">
                <i class="far fa-circle"></i>acesso aos dados;
              </li>
              <li class="mb-2">
                <i class="far fa-circle"></i>correção de dados incompletos,
                inexatos ou desatualizados;
              </li>
              <li class="mb-2">
                <i class="far fa-circle"></i>anonimização, bloqueio ou
                eliminação de dados desnecessários, excessivos ou tratados em
                <br />
                desconformidade com o disposto na lei;
              </li>
              <li class="mb-2">
                <i class="far fa-circle"></i>portabilidade dos dados a outro
              ...
              <li class="mb-2">
                <i class="far fa-circle"></i>eliminação dos dados pessoais
                tratados com o consentimento do titular, exceto nos casos
                <br />
                previstos em lei;
              </li>
              <li class="mb-2">
                <i class="far fa-circle"></i>informação das entidades públicas e
                privadas com as quais o controlador realizou uso
                <br />
                compartilhado de dados;
              </li>
              <li class="mb-2">
                <i class="far fa-circle"></i>informação sobre a possibilidade de
                não fornecer consentimento e sobre as consequências
                <br />
                da negativa;
              </li>
              <li class="mb-2">
                <i class="far fa-circle"></i>revogação do consentimento.
              </li>
            </ul>
            <p>
            ...
            <p>
              ...
              caminho: ""****"". Alternativamente, se desejar, o titular poderá
              enviar um e-mail ou uma correspondência ao nosso Encarregado de
            ...
            <p>
              <strong>10. Reclamação a uma autoridade de controle</strong>
            </p>
            <p>
            ...
            <p>
              Endereço postal: Travessa Srg. Duque, 85 – Industrial, Aracaju –
              SE, 49065-750
            </p>
          </div>
          <form method="dialog">
            <button className="btn btn-sm btn-circle btn-ghost absolute right-2 top-2 text-verdeTokSeg">
              ✕
            </button>
          </form>
        </div>
      ...
      <div className="container mx-auto flex flex-col justify-center items-center relative w-full max-w-[1256px] space-y-4 px-4">
        <img src={logo} alt="Logo da Empresa" className="w-56 h-auto mb-4" />
          ...
          <div className="flex flex-col justify-center items-center md:items-start space-y-2">
            ...
            <div className="flex flex-row">
              ...
              <p className="text-center">
                Rua José Antônio Braga 3-82, 17018-540 - Vila Aviação, Bauru -
                SP
              </p>
            </div>
          </div>
        ...
        <div className="border-t w-full">
          <p className="text-center pt-2 text-sm">
            © TokSeg. Todos os direitos reservados
          </p>
        </div>
      </div>
    </footer>
