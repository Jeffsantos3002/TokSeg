...
export default function Banner (){
  return(
    <div className='w-full flex justify-center px-4 py-24 bg-white'>
      <div className=" w-full flex flex-col lg:flex-row justify-between items-center w-full max-w-[1256px] ">
        <div className='flex flex-col items-center lg:items-start ' >
          ...
          <div className='flex flex-col items-center lg:items-start space-y-12 w-11/12	lg:w-full'>
            <h1 className='text-pretoTokSeg sm:text-7xl text-4xl text-center lg:text-start font-semibold '>A MELHOR SOLUÇÃO <br />PARA O SEU CONDOMÍNIO.</h1>
            <p className='text-pretoHover text-center sm:text-start text-2xl	'>Simples, fácil e completo é a nossa portaria inteligente.</p>
        ...
        <img src={banner} alt='image-banner' title='image-banner' className='w-full  relative left-[-120px]' />
