      ...
      <div className=" w-full flex flex-col lg:flex-row justify-center items-center w-full max-w-[1256px] ">
        <div className='flex flex-col items-center lg:items-start' >
          ...
          <div className='flex flex-col items-center lg:items-start space-y-12 w-11/12	lg:w-full'>
            <h1 className='text-pretoTokSeg sm:text-7xl text-4xl text-center lg:text-start font-semibold '>TOKSEG, A MELHOR SOLUÇÃO PARA O SEU CONDOMÍNIO.</h1>
            <p className='text-pretoHover text-2xl	'>Simples, facial e completo é a nossa portaria inteligente.</p>
